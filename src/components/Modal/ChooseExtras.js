...
import CommonAllergens from "../menu/CommonAllergens";
import Diets from "../menu/Diets";
import AdditionalLabel from "../menu/AdditionalLabel";

const ChooseExtras = ({ showExtras, setShowExtras }) => {
  return (
    <div>
      <input defaultChecked={showExtras} type="checkbox" className="modal-toggle" />
      <div class="modal">
        <div class="modal-box bg-white">
          <div class="modal_header mb-[45px] flex gap-5">
            <h3 class="font-bold text-text_color text-2xl">Choose extras</h3>
            <span>
              <svg
