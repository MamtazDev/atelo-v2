...
const ChooseSize = ({ showSize, setShowSize }) => {
  return (
    <div>
      <input defaultChecked={showSize} type="checkbox" className="modal-toggle" />
      <div class="modal">
        <div class="modal-box bg-white">
          <div class="modal_header mb-[45px] flex gap-5">
            <h3 class="font-bold text-text_color text-2xl">Choose a size</h3>
            <span>
              <svg
