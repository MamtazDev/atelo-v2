    ...
    <div class="flex-1 bg-white py-11 px-10">
      ...
      <div class="mb-5">
        <div class="flex justify-between">
          <div class="heading">
            <h2 class="text-2xl font-bold text-c_33">Menus</h2>
            <p class="text-base font-normal text-c_85">
              Add any information that your customers should know
            </p>
          </div>

          <Link href="/menu-settings" class="setting">
          ...
          >
            <div class="w-full md:w-12/12 xl:w-12/12 p-6">
              <div class="add-menu flex items-center justify-between">
                <Link href={menu.item === 0 ? "/new-menu" : "/menu-item"} class="menu-name">
                ...
                <div class="menu-setting flex items-center gap-1 sm:gap-16 md:gap-32">
                  <div class="btn-toggle">
                    <label htmlFor={index} class="cursor-pointer">
                      {/* <!-- toggle --> */}
